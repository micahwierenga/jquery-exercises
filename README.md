...
<ol>
  ...
  <li>Use jQuery to create a `click` event listener so that, when each list item is clicked, text is appended somewhere on the page. You can append it to the body or a div that you create or a paragraph that you create, or any other html element that will display text</li>
</ol>
...
<ol>
  ...
  <li>Use jQuery to create a `mouseover` listener that changes the text of these list items (you choose the text that it changes to).</li>
</ol>
